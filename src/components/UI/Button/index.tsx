...
export const buttonVariants = tv({
  ...
  variants: {
    variant: {
      default:
        "bg-primary-100 text-text hover:bg-primary-100/70 icon:stroke-white",
      destructive: "bg-red-80 text-white hover:bg-red-40 icon:stroke-white",
      outline:
        "border border-primary-100 bg-background  hover:bg-primary-100 hover:text-black-100 icon:stroke-primary-100 icon:hover:stroke-black-10",
      secondary:
        "bg-white text-text hover:bg-primary-100/80 icon:stroke-primary-100/80",

      link: "text-primary-100 icon:stroke-primary-100 underline-offset-4 hover:underline ",
    },
    size: {
